...
The L<Mojolicious> team for producing an excellent product that
offers light-weight implementations of many useful tools. This module was
adapted directly from L<Mojo::JSON>.
...
pure-regexp JSON parser (L<PerlMonks|http://www.perlmonks.org/?node_id=995856>).
