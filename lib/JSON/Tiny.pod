...
Most of the remainder of this document is adapted directly from L<Mojo::JSON>.
...
in either case would only be a factor in applications such as CGI, where
...
exist or be as well designed and tested if it had to be written from scratch.

Also to Randal Schwartz for demonstrating to Los Angeles Perl Mongers
