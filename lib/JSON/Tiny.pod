...
including blessed references will work.  The setting must be made prioror to 
...
L<JSON::Tiny> has under 320 lines of code; a single-file module -- good for 
embedding. Distribution: 19KB.
...
See C<examples/json_benchmark.pl> for benchmark code.
...
Incompatible with L<Exporter> versions that predate Perl 5.8.4. For older 
Perl versions upgrade Exporter to version 5.59 or newer.
...
L<Mojo::JSON>, L<JSON>, L<RFC 7159|http://tools.ietf.org/html/rfc7159>.
