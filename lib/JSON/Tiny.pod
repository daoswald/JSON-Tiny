...
Perl 5.8.1 or newer.  B<Note>: Perl 5.10+ is recommended due to bugs in
Perl 5.8's regular expression engine.
...
(Sept 2012). He wasn't involved in JSON::Tiny, but exploring alternatives to
his solution led to this fork of L<Mojo::JSON>.
